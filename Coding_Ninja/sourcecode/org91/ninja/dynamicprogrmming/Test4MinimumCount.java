...
and {2^2}. The output will be 1, as 1 is the minimum count of numbers required to represent N as sum of squares.
...
public class Test4MinimumCount {
	public static int minCount(int n) {
		...
		minSquaresRequired[i] = Math.min(minSquaresRequired[i], minSquaresRequired[i -
		(j * j)]);
		}
