...
number of steps that 'n' has to take to get reduced to 1. You can perform any one of the following 3 steps:
...
*/
public class Test3_MinStepsToOne_DP {
	public static int countMinStepsToOne(int n) {
		...
		minSteps[currStep] = 1 + Math.min(subtractOne, Math.min(divideByTwo,
		divideByThree));
		}
		return minSteps[n];
		}
