...
You need to search for the integer X in the given array/list using 'Linear Search'.
 ...
 index at which the first occurrence of X would be encountered. In case X is not present in the array/list, then return -1.
 ...
 *
 */
public class Test3_Linear_Search {
