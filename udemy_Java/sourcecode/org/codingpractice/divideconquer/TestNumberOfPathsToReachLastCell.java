...
public class TestNumberOfPathsToReachLastCell {
		
	private int numberOfPaths(int[][] array , int row , int col,int cost) {
	...
	public static void main(String[] args) {
		int[][] array = { 
						  ...
						  { 7, 1, 6, 3 } };
		int cost = 25;
		TestNumberOfPathsToReachLastCell nop = new TestNumberOfPathsToReachLastCell();
