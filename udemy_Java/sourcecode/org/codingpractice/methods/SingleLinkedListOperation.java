 ...
 * 
 * @author amir.ansari
 * implement of all the operation of single linked
 * list like insertion,searching ,deletion etc.
 *
 */
public class SingleLinkedListOperation {
	...
	// print ths list
	public void printList(SingleNode mNode) {
		 
		SingleNode current = mNode;
