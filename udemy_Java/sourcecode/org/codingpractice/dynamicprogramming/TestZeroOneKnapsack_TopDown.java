...
public class TestZeroOneKnapsack_TopDown {
 ...
 private int knapsackAux(Integer[] []dp, int[] profits,int[] weights, int capacity, 
		 int currentIndex) {
 ...
 public static void main(String[] args) {
	 TestZeroOneKnapsack_TopDown ks = new TestZeroOneKnapsack_TopDown();
